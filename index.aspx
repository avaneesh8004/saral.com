...
<form id="form1" runat="server">
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a  href="index.aspx"><img src="assets/img/portfolio/saralicon.png" class="logoicon" width="220px" /></a></h1>
...
<!--    <section id="clients" class="clients section-bg">
  ...
  <div class="section-title">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-pre">
            <div class="portfolio-img"><img src="assets/img/portfolio/admission.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Admission Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/admission.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
           ...
           <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/mis.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Student Information Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/mis.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="modules/studentInformation.aspx" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
           <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/student attaendance.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Student Attendence Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/student attaendance.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="modules/Studentattendence.aspx" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
           <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/exam.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Student Examination Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/exam.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/timetable.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Syllabus And Time Table Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/timetable.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/library.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Library Management System</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/library.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/trainingplacement.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Training And Placement Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/trainingplacement.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/Alumni.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Alumni Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/Alumni.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Acadmics">
            <div class="portfolio-img"><img src="assets/img/portfolio/grievance.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Grievence And Feedback</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/grievance.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-Financial">
            <div class="portfolio-img"><img src="assets/img/portfolio/fee.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Fee Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/fee.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Financial">
            <div class="portfolio-img"><img src="assets/img/portfolio/payroll.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Payroll Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/payroll.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Financial">
            <div class="portfolio-img"><img src="assets/img/portfolio/bookkeeping.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4> Financial Accounting & Book keeping</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/bookkeeping.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-Administrative">
            <div class="portfolio-img"><img src="assets/img/portfolio/staff.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Staff Attendence Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/staff.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Administrative">
            <div class="portfolio-img"><img src="assets/img/portfolio/hr2.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Staff & HR Information Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/hr2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Administrative">
            <div class="portfolio-img"><img src="assets/img/portfolio/transport.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Transport Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/transport.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Administrative">
            <div class="portfolio-img"><img src="assets/img/portfolio/hostel.jpg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Hostel Management</h4>
              <p>Module</p>
              <a href="assets/img/portfolio/hostel.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-Administrative">
            ...
            <div class="portfolio-info">
              ...
              <p>Module</p>
              <a href="assets/img/portfolio/inventory.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
